...
<div class="container">
  <form action='/LineOperator03/GetOrder' method='post'>
  <div class="row">
    <div class="col-25">
...
$htmltable = @"
  ...
  <form action='/LineOperator03/Print' method='post'>
  <br>
  <div class="row">
  ...
  <form action='/LineOperator03/ClearPrintJobs' method='post'>
  <br>
  <div class="row">
...
$ordernumbercontent = Get-content ".\DataToPrint\L03\temp\$ordernumber.csv" | ConvertFrom-Csv -Delimiter ','
}
Else
{ 
